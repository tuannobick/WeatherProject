...
const char* ssid     = "TUANNOBI";       ///EDIIIT
const char* password = "112143candylilom"; //EDI8IT
String town="Melbourne";              //EDDIT
String Country="AU";                //EDDIT
const String endpoint = "http://api.openweathermap.org/data/2.5/weather?q="+town+","+Country+"&units=metric&APPID=";
const String key = "e2eaa933d99de87426243c51b54f5904"; /*EDDITTTTTTTTTTTTTTTTTTTTTTTT                      */
...
//WiFiUDP ntpUDP;
//NTPClient timeClient(ntpUDP, "europe.pool.ntp.org", 3600, 396000);
///////////////////////////////////////////////////////////////////////////////////////////
...
// Initialize a NTPClient to get time
  ...
  // GMT -1 = -3600
  // GMT 0 = 0
 // timeClient.setTimeOffset(39600);   /*EDDITTTTTTTTTTTTTTTTTTTTTTTT                      */
  getData();
  delay(500);
}
int i=0;
